...
val keyPropertiesFile: File = rootProject.file("keys.properties")
val keysProperties = Properties()
keysProperties.load(FileInputStream(keyPropertiesFile))

android {
    namespace = "com.rcalderon.kodecochat"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.rcalderon.kodecochat"
        minSdk = 28
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
